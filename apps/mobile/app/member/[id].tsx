...
import { timeAgo, getStatusColor, getBatteryColor } from '@/lib/simulatedData'
    ...
    >
      ...
      {member.isWearingWatch ? (
        ...
        >
          ...
          <Text style={{ color: '#a1a1a1', fontSize: 14, marginTop: 8 }}>Watch not connected</Text>
      ...
      {member.activeEpisode &&
        member.activeEpisode.phase !== 'resolved' &&
        (() => {
          ...
          <View key={i}>
            ...
            >
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={{ color: '#737373', fontSize: 11 }}>{timeAgo(entry.timestamp)}</Text>
              </View>
            </View>
          </View>
        ))}
