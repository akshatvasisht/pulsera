...
import { timeAgo, getStatusColor, getBatteryColor, type MemberLocation } from '@/lib/simulatedData'
    ...
    >
      ...
      <GlassCard
        ...
        style={{
          marginBottom: 20,
          borderLeftWidth: 3,
          borderLeftColor: hasActiveEpisode ? '#ff6467' : allSafe ? '#00bc7d' : '#fe9a00',
        }}
      >
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 10 }}>
          <Ionicons
            name={hasActiveEpisode ? 'alert-circle' : allSafe ? 'shield-checkmark' : 'warning'}
            size={22}
            color={hasActiveEpisode ? '#ff6467' : allSafe ? '#00bc7d' : '#fe9a00'}
          />
          <View style={{ flex: 1 }}>
      ...
      {[...members]
        .sort((a, b) => b.health.heartRate - a.health.heartRate)
        .map((member) => (
          <MemberCard
            key={member.id}
            member={member}
        ...
        <Pressable onPress={onPress} style={{ padding: 16 }}>
          <View style={{ flexDirection: 'row', alignItems: 'center' }}>
            ...
            <View style={{ alignItems: 'flex-end', gap: 4 }}>
              ...
              <Text style={{ color: '#737373', fontSize: 10 }}>{timeAgo(member.lastUpdated)}</Text>
