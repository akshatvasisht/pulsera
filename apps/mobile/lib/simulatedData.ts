...
export const FAMILY_MEMBERS: MemberLocation[] = [
  {
    ...
    history: [
      { latitude: 33.952, longitude: -83.385, timestamp: minutesAgo(180), locationName: 'Home' },
      {
        latitude: 33.949,
        longitude: -83.381,
  ...
  },
  {
    ...
    history: [
      { latitude: 33.952, longitude: -83.385, timestamp: minutesAgo(300), locationName: 'Home' },
      {
        latitude: 33.951,
        longitude: -83.383,
      ...
      { latitude: 33.952, longitude: -83.385, timestamp: minutesAgo(30), locationName: 'Home' },
    ],
  },
  {
    id: 'carlos',
    ...
    history: [
      { latitude: 33.952, longitude: -83.385, timestamp: minutesAgo(240), locationName: 'Home' },
      { latitude: 33.95, longitude: -83.38, timestamp: minutesAgo(60), locationName: 'Downtown' },
      {
        latitude: 33.9445,
        longitude: -83.374,
        timestamp: minutesAgo(30),
  ...
  },
  {
    ...
    history: [
      { latitude: 33.952, longitude: -83.385, timestamp: minutesAgo(360), locationName: 'Home' },
      {
        latitude: 33.948,
        longitude: -83.3773,
