...
export type RingNotificationType = 'episode-alert' | 'episode-resolved' | 'pulse-checkin'
...
export function pushNotification(n: Omit<RingNotification, 'id' | 'dismissed'>): string {
