...
export function login(email?: string, token?: string): Promise<AuthResponse> {
...
export function joinGroup(groupId: string, inviteCode: string): Promise<JoinGroupResponse> {
...
export function joinGroupByCode(inviteCode: string): Promise<JoinGroupResponse> {
...
export function removeMember(groupId: string, userId: string): Promise<{ message: string }> {
