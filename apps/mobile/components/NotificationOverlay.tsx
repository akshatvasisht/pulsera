                  ...
                  >
                    <View style={{ flex: 1 }}>
                      ...
                      <Text style={{ color: colors.text, fontSize: 15, fontWeight: '700' }}>
                        {notification.presageData.visualHeartRate}{' '}
                        <Text style={{ fontSize: 10, color: colors.textMuted }}>BPM</Text>
                      </Text>
                    </View>
                    <View style={{ flex: 1 }}>
                      <Text style={{ color: colors.textMuted, fontSize: 10, marginBottom: 2 }}>
                      ...
                      <Text style={{ color: colors.text, fontSize: 15, fontWeight: '700' }}>
                        {notification.presageData.breathingRate}{' '}
                        <Text style={{ fontSize: 10, color: colors.textMuted }}>/min</Text>
                      </Text>
                    </View>
                  </View>
