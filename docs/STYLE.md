...
- Comments must explain _why_ a decision was made, not narrate _what_ the code does.
- The code itself should be self-explanatory for the _what_.
...
- **Descriptive titles:** Explain _what_ and _why_, not _how_.
